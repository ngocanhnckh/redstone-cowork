export const IPC = {
  ...
  faceAdminCount: "api:face:admin-count",
  faceAdminClear: "api:face:admin-clear",
  faceClearOwn: "api:face:clear-own",
  ...
  serverDelete: "api:servers:delete",
  ...
  accountUpdateProfile: "api:accounts:profile",
  accountSetDisabled: "api:accounts:disabled",
  accountDelete: "api:accounts:delete",
  accountsAudit: "api:accounts:audit",
  ...
  agencyChatList: "api:agency:chat:list",
  agencyChatPost: "api:agency:chat:post",
  ...
  agencyMissionDetail: "api:agency:mission:detail",
  ...
  agencyAgent: "api:agency:agent",
  agencyGithubRoster: "api:agency:github-roster",
  agencyWeek: "api:agency:week",
  agencyWeekConfig: "api:agency:week:config",
  scoringBoard: "api:scoring:board",
  scoringMy: "api:scoring:my",
  scoringHistory: "api:scoring:history",
  scoringProjects: "api:scoring:projects",
  scoringAgentWeek: "api:scoring:agent-week",
  scoringConfigGet: "api:scoring:admin:config:get",
  ...
  scoringJiraStatuses: "api:scoring:admin:jira-statuses",
  ...
  scoringPenalties: "api:scoring:admin:penalties",
  scoringVoidPenalty: "api:scoring:admin:penalty:void",
  scoringScan: "api:scoring:admin:scan",
  ...
  filesSearchStart: "api:files:search:start",
  filesSearchCancel: "api:files:search:cancel",
  filesSearchEvent: "api:files:search:event",
