...
export default function CustomAppPanel({ app, onFavicon }: { app: CustomApp; onFavicon: (id: string, url: string) => void }) {
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, minHeight: 0, position: "relative", background: themed ? "color-mix(in srgb, var(--app-panel) 40%, transparent)" : "rgba(0,0,0,0.18)", backdropFilter: themed ? "blur(18px) saturate(1.3)" : undefined, WebkitBackdropFilter: themed ? "blur(18px) saturate(1.3)" : undefined }}>
