...
export type SfxName = "button" | "message" | "loading" | "pageloaded" | "keystroke" | "boot" | "output" | "scan";

const SRC: Record<SfxName, string> = { button: buttonUrl, message: messageUrl, loading: loadingUrl, pageloaded: pageloadedUrl, keystroke: keystrokeUrl, boot: bootUrl, output: outputUrl, scan: scanUrl };
...
const MIN_GAP_MS: Record<SfxName, number> = { button: 40, message: 400, loading: 600, pageloaded: 300, keystroke: 20, boot: 4000, output: 180, scan: 500 };
