...
declare global {
  ...
  interface Window {
    cowork: {
      ...
      scoringBoard(project: string, week?: string): Promise<import("../../shared/scoring").ScoringBoard>;
      scoringMy(project?: string): Promise<import("../../shared/scoring").MyScore>;
      scoringHistory(project?: string): Promise<import("../../shared/scoring").ScoreHistory>;
      scoringProjects(): Promise<import("../../shared/scoring").ScoringProjectRef[]>;
      scoringAgentWeek(): Promise<import("../../shared/scoring").AgentWeekAward>;
      scoringConfigGet(project: string): Promise<import("../../shared/scoring").ScoringProjectConfig>;
      ...
      scoringPenalties(project: string, includeVoided: boolean): Promise<import("../../shared/scoring").ScoringPenaltyView[]>;
      scoringVoidPenalty(id: string): Promise<{ ok: boolean }>;
      scoringScan(project: string): Promise<{ completions: number; penalties: number }>;
